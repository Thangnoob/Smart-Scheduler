    ...
    <div className="bg-gray-50 text-gray-800 font-sans">
      ...
      <div className="text-center py-16 px-6 bg-white">
        ...
        <p className="text-gray-600 mt-4 max-w-xl mx-auto">
          Tối ưu hóa thời gian học tập với AI, theo dõi tiến độ thông minh và
          gamification để duy trì động lực học tập mỗi ngày.
        </p>
        <button
        ...
        <p className="text-sm text-gray-500 mt-2">
          Miễn phí – Không cần tải ứng dụng
        </p>
        <div className="flex justify-center gap-10 mt-10 text-sm sm:text-base">
          <div>
            <span className="text-indigo-600 font-bold text-xl">10,000+</span>
            <br />
            Giờ học được lên lịch
          </div>
          <div>
            <span className="text-green-600 font-bold text-xl">95%</span>
            <br />
            Sinh viên cải thiện hiệu suất
          </div>
          <div>
            <span className="text-orange-600 font-bold text-xl">1,500+</span>
            <br />
            Người dùng hài lòng
          </div>
        </div>
      ...
      <div className="bg-white py-16 text-center">
        ...
        <p className="text-gray-600 mb-6">
          Hàng nghìn sinh viên đã tin tưởng StudyFlow để quản lý thời gian học
          tập hiệu quả.
        </p>
        <button
